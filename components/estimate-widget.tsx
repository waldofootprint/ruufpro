// Estimate Widget — 7-step flow inspired by Roofr's UX but with
// our contractor-safe "Ballpark Estimate" language and premium feel.
//
// Flow: Address → Pitch → Current Material → Desired Material →
//       Timeline+Financing → Contact Info → Estimate Reveal
//
// Price is gated behind contact info (like Roofr) to maximize lead capture.
            ...
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                  Get a <span className="underline decoration-brand-500 underline-offset-4">free</span> ballpark estimate
                </h2>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3.5 rounded-xl border border-gray-200 text-gray-900 placeholder-gray-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 focus:outline-none transition-all text-base"
                  />
                </div>
              </div>

              {/* Satellite map placeholder — will be replaced with actual Google Maps embed */}
              {address.length > 5 && (
