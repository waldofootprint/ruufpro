      ...
      <div className="overflow-hidden rounded-3xl bg-white p-8 md:p-10 shadow-xl transition-shadow duration-500 hover:shadow-2xl relative">
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className={address.length < 5 ? "opacity-40 pointer-events-none" : ""}>
              <FlowButton text="Continue" onClick={nextStep} />
            </div>
          </div>
        )}
        ...
        {step === 6 && (
          <div className="space-y-8">
            ...
            <div className={!timeline || !financing ? "opacity-40 pointer-events-none" : ""}>
              <FlowButton text="Continue" onClick={nextStep} />
            </div>
          </div>
        )}
        ...
        {step === 7 && (
          <div className="space-y-5">
            ...
            <div className={loading || !agreedToTerms || !name || !email || !phone ? "opacity-40 pointer-events-none" : ""}>
              <FlowButton text={loading ? "Calculating..." : "Get my estimate"} onClick={handleSubmit} />
            </div>
          </div>
        )}
