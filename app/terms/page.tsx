    ...
    <div className="min-h-screen bg-[#0F2A37]">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 md:px-10 md:py-24">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-white/70 leading-relaxed [&_h2]:font-[family-name:var(--font-sora)] [&_h2]:text-white [&_h2]:text-xl [&_h2]:font-bold [&_h2]:mt-12 [&_h2]:mb-4 [&_h3]:text-white/90 [&_h3]:text-base [&_h3]:font-semibold [&_h3]:mt-8 [&_h3]:mb-3 [&_a]:text-[#D4863E] [&_a]:underline [&_ul]:space-y-1 [&_ul]:ml-4 [&_li]:text-white/60">
          ...
          <h3>Opting in</h3>
          <p>By opting in to the RuufPro text messaging program, you agree to receive recurring SMS messages from us. Message frequency varies based on account activity. You can opt out at any time by replying STOP to any message.</p>
          ...
          <h3>Opting out</h3>
          <p>If you wish to opt out of receiving SMS messages, you may do so by replying with &quot;STOP&quot; to any SMS message you receive from us. Upon opting out, you will receive a final confirmation message, and you will no longer receive any further SMS messages unless you opt in again.</p>
