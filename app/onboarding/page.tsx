...
type Screen = "basics" | "crawl" | "fine-tune" | "ship";
  ...
  return (
    <main className="neu-dashboard min-h-screen flex items-center justify-center px-4 py-12">
      <div style={{ width: "100%", maxWidth: 640 }}>
        ...
        {screen === "crawl" && (
          <PlaceholderScreen
            title="URL crawl — coming in §6.2"
            body="Riley will scan your existing site and pre-fill what she knows about your business."
        ...
        {screen === "fine-tune" && (
          <PlaceholderScreen
            ...
            body="Tweak what Riley will say. Owner name, warranty, financing, differentiators."
            onBack={() => setScreen("crawl")}
          />
        )}
...
function ProgressDots({ current }: { current: Screen }) {
  const order: Screen[] = ["basics", "crawl", "fine-tune", "ship"];
