// RoofReady Embed Script
// Roofers paste this on their website:
// <script src="https://roofready.com/widget.js" data-contractor="abc123"></script>
//
...
(function () {
  ...
  if (!contractorId) {
    console.error("RoofReady: Missing data-contractor attribute on script tag.");
    return;
  }
  ...
  iframe.setAttribute("title", "RoofReady Estimate Widget");

  // Auto-resize iframe to fit content
  window.addEventListener("message", function (event) {
    if (event.data && event.data.type === "roofready-resize") {
